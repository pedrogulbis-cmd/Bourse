...
// ---------- Pays disponibles (code ISO utilisé par le param "country" de FMP) ----------
const COUNTRIES = [
...
const ZONES = [
  ...
  {id:"eu", label:"Europe", countries:["FR","DE","GB","IT","ES","NL","CH","SE","BE","DK","NO","FI","IE","PT","AT"]},
  {id:"apac", label:"Asie-Pacifique", countries:["JP","AU","HK","SG","KR","TW","CN","IN"]},
  {id:"world", label:"Monde (sélection large)", countries:["US","CA","GB","FR","DE","CH","NL","JP","AU","KR","HK","SE"]},
];
